    ...
    >
      ...
      >
        ...
        >
          {works.map((work) => (
            <div
              className="flex max-md:border max-md:border-[#ffe8dc] max-md:p-4 rounded-md w-full xl:w-[70%] md:max-h-[350px] flex-wrap-reverse md:absolute bg-[#111] bg-noise md:translate-y-full overflow-hidden first:translate-y-0 max-md:justify-center max-md:gap-8"
              key={work.id}
            >
